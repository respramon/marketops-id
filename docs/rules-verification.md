...
| No project code may have been written before 19 August 2026. Planning, research, sketches, and designs before the window were allowed. | [Official rules](https://hackathon.sectors.app/rules) | 2026-08-26 | REPOSITORY HISTORY VERIFICATION PENDING | Before submission, verify that commit history and project files support a build-period start. |
| The project repository must be created during the build period. Judges may inspect commit history. | [Official rules](https://hackathon.sectors.app/rules) | 2026-08-26 | REPOSITORY HISTORY VERIFICATION PENDING | Verify repository creation and first commit dates are no earlier than 19 August 2026. Do not make an unsupported claim in the README or video. |
...
| Submission requires a **public repository link**. | [Official rules](https://hackathon.sectors.app/rules) | 2026-08-26 | PUBLIC REPOSITORY PENDING | Create/push the final repository using the participant's GitHub access and verify anonymous public access before submission. |
